...
/**
 * Compliance & Logs — one page for "what's the state of every date" AND
 * "what did the system actually send about it." Merged from the old /app/alerts
 * (which now redirects here): the status list is the work surface, the sent
 * ledger under it is the receipt. Same data, one stop.
 */
