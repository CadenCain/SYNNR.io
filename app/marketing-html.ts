    ...
    <div class="prices">
      <div class="price reveal" data-d="1">
        ...
        <div class="feats">
          ...
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6 9 17l-5-5"/></svg>1,500 sheets / seat / mo included</li>
...
<section class="section" id="faq">
  <div class="container">
    ...
    <div class="faq reveal" data-d="1">
      ...
      <div class="qa"><button>What does it cost?<span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12h14"/></svg></span></button><div class="ans"><p>TallyShot is per seat: $39/user/mo, dropping to $34 at 10 seats and $29 at 25 — volume discounts apply automatically. Each seat includes 1,500 sheets/mo (pooled across your org); extra sheets are $0.05 each. 50+ seats: talk to us. Each future app is priced on its own.</p></div></div>
