...
import DashboardView, { type DashSnap } from "@/app/app/_components/dashboard-view";

export const metadata: Metadata = { robots: { index: false, follow: false } };
import type { UnitTile } from "@/lib/saas/readiness";

/**
 * Screenshot harness + shareable peek. Renders the REAL
 * dashboard component with the sample-yard dataset so headless Chrome can
 * photograph the actual product for the marketing site — the pictures can
 * never drift from what ships. Same rule as the in-app sample yard:
 * representative data, real UI, nothing the product can't do. noindexed;
 * it's a camera stand, not a landing page.
 */
